...
#[inline]
pub unsafe fn CAM_ZOOM_IN_arg6(agent: &mut L2CAgentBase, zoom_frames: f32, object_id: f32, zoom_amt: f32, y_rot: f32, x_rot: f32, quake_bool: bool) {
    agent.clear_lua_stack();
    lua_args!(agent, zoom_frames, object_id, zoom_amt, y_rot, x_rot, quake_bool);
